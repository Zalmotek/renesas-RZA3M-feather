...
void max31723_init() {
    ...
    err = R_RSPI_Write(&g_spi0_ctrl, &config_sensor[0], sizeof(config_sensor), SPI_BIT_WIDTH_8_BITS);
    ...
    err = R_RSPI_Read(&g_spi0_ctrl, &config_read[0], sizeof(config_read), SPI_BIT_WIDTH_8_BITS);
...
float get_temperature() {
    ...
    err = R_RSPI_WriteRead(&g_spi0_ctrl, read_temperature_reg, temperature_values, sizeof(temperature_values), SPI_BIT_WIDTH_8_BITS);
 ...
 * @retval      None
 **********************************************************************************************************************/
static void spi_event_check(void)
{
