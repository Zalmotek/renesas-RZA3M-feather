...
{
{ .pin = BSP_IO_PORT_01_PIN_02, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_B01 | (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
        | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PERIPHERAL_MODE4) },
  { .pin = BSP_IO_PORT_01_PIN_03, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_B01 | (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PERIPHERAL_MODE4) },
  { .pin = BSP_IO_PORT_01_PIN_04, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_B01 | (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PERIPHERAL_MODE4) },
