...
#define BSP_CFG_CLOCK_PLL5_INTIN (66U) /* PLL5: INTIN */
#define BSP_CFG_CLOCK_PLL5_FRACIN (0U) /* PLL5: FRACIN */
#define BSP_CFG_CLOCK_PLL5_POSTDIV1 (1U) /* PLL5: POSTDIV1 */
#define BSP_CFG_CLOCK_PLL5_POSTDIV2 (2U) /* PLL5: POSTDIV2 */
#define BSP_CFG_SEL_PLL5_SET_SOURCE BSP_CLOCKS_SOURCE_CLOCK_PLL5_FOUT1PH0 /* PLL5_4 Sel: PLL5 /2 */
#define BSP_CFG_DIVDSIA_SET_DIV (BSP_CLOCKS_DSIA_DIV_2) /* DSI_A Div /2 */
#define BSP_CFG_DIVDSIB_SET_DIV (BSP_CLOCKS_DSIB_DIV_3) /* DSI_B Div /3 */
#define BSP_CFG_CLOCK_M3CLK_HZ (66000000) /* M3CLK 66000000Hz */
#define BSP_CFG_CLOCK_M1CLK_HZ (792000000) /* M1CLK 792000000Hz */
