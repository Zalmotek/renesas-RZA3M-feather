...
{
{ .pin = BSP_IO_PORT_00_PIN_02, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_B01 | (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
        | (uint32_t) IOPORT_CFG_SLEW_RATE_SLOW | (uint32_t) IOPORT_PERIPHERAL_MODE2) },
  { .pin = BSP_IO_PORT_00_PIN_03, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_B01 | (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
          | (uint32_t) IOPORT_CFG_SLEW_RATE_SLOW | (uint32_t) IOPORT_PERIPHERAL_MODE2) },
  ...
  { .pin = BSP_IO_PORT_10_PIN_00, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_B01
          ...
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST) },
  { .pin = BSP_IO_PORT_10_PIN_01, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_B01 | (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PERIPHERAL_MODE1) },
