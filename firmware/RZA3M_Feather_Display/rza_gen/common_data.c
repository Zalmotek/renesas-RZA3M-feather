...
const mipi_dsi_b_extended_cfg_t g_mipi_dsi0_extended_cfg =
        { .dsi_seq0.ipl = (24), .dsi_seq0.irq = DSI_INT_SEQ0_IRQn,
        ...
        .dsi_seq1.ipl = (24),
          ...
          .dsi_plie = R_MIPI_DSI_PLIER_DLTOULPS_Msk | R_MIPI_DSI_PLIER_DLFROMULPS_Msk | 0x0, .dsi_vmie =
                  R_MIPI_DSI_VICH1IER_VBUFUDF_Msk | R_MIPI_DSI_VICH1IER_VBUFOVF_Msk | 0x0,
          .dsi_sqch0ie = R_MIPI_DSI_SQCH0IER_AACTFIN_Msk | R_MIPI_DSI_SQCH0IER_ADESFIN_Msk
                  | R_MIPI_DSI_SQCH0IER_PKTBIGERR_Msk | R_MIPI_DSI_SQCH0IER_TXIBERR_Msk
                  | R_MIPI_DSI_SQCH0IER_RXFATALERR_Msk | R_MIPI_DSI_SQCH0IER_RXFAIL_Msk
                  | R_MIPI_DSI_SQCH0IER_RXPKTDFAIL_Msk | R_MIPI_DSI_SQCH0IER_RXCORERR_Msk
                  | R_MIPI_DSI_SQCH0IER_RXAKE_Msk | 0x0,
